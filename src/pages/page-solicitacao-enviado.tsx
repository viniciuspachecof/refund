...
import iconeSolicitacaoEnviada from '../assets/img-solicitacao-enviada.svg';
import type { FormEvent } from 'react';

export function PageSolicitacaoEnviado() {
  const navigate = useNavigate();

  function handleNewRequest(e: FormEvent) {
    e.preventDefault();
  ...
  return (
    <div className="max-w-lg m-auto mb-14 bg-white p-10 rounded-2xl justify-center">
      ...
      <img src={iconeSolicitacaoEnviada} alt="" className="m-auto mb-6" />
